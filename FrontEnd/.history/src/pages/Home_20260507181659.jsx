...
function Home() {
  return (
    <section style={{backgroundImage:`url(${backgroundImage})`,}} className={`bg-cover bg-tertiary h-screen bg-center flex items-center justify-center`}>
      ...
      <button className='outline-none px-4 py-1  text-2xl border border-orange-600 hover:bg-orange-600 hover:text-white transitio text-orange-600 '>Share Your Recipe With Us</button>
      </div>
      {/* <div className='right'>
