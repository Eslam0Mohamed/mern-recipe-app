...
function Home() {
  return (
    <section style={{backgroundImage:`url(${backgroundImage})`,}} className={`bg-cover bg-tertiary h-screen bg-center flex items-center justify-center `}>
      ...
      <button className='w-fit outline-none px-4 py-1  text-xl border cursor-pointer border-orange-600 bg-orange-600 text-white transition-colors duration-150 rounded-md '>Share Your Recipe With Us</button>
      </div>
      {/* <div className='right'>
