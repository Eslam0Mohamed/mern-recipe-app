...
function Home() {
  return (
    <section style={{backgroundImage:`url(${backgroundImage})`,}} className={`bg-cover bg-tertiary h-screen bg-cen flex items-center justify-center`}>
      ...
      <button className='outline-none px-4 py-1 text-md text-orange-600 '>Share Your Recipe With Us</button>
      </div>
      {/* <div className='right'>
